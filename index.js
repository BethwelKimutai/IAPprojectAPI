...
app.get('/users/:gender', authenticateToken, (req, res) => {
    ...
    connection.query(
        'SELECT * FROM doctors WHERE gender = ?',
        [userGender],
        (err, doctorResults) => {
            if (err) {
                console.error(err);
            ...
            connection.query(
                ...
                (err, patientResults) => {
                    ...
                    connection.query(
                        'SELECT * FROM pharmacies WHERE gender = ?',
                        [userGender],
                        (err, pharmacistResults) => {
                            ...
                            connection.query(
                                'SELECT * FROM admins WHERE gender = ?',
                                [userGender],
...
app.get('/users/:id', authenticateToken, (req, res) => {
    ...
    connection.query(
        ...
        (err, doctorResults) => {
            ...
            connection.query(
                'SELECT * FROM patients WHERE SSN = ?',
                [userId],
                (err, patientResults) => {
                    if (err) {
                        console.error(err);
                    ...
                    // Query for tbl_admin
                    connection.query(
                        'SELECT * FROM api_access WHERE ID_SSN = ?',
                        [userId],
                        (err, adminResults) => {
                            if (err) {
                                console.error(err);
                            ...
                            connection.query(
                                ...
                                (err, pharmacistResults) => {
                                    ...
                                    // Query for tbl_pharmcom
                                    connection.query(
                                        'SELECT * FROM pharmaceutical_companies WHERE SSN = ?',
                                        [userId],
                                        (err, pharmcomResults) => {
                                            if (err) {
                                                console.error(err);
                                            ...
                                            // Store pharmcom results
                                            results.pharmcom = pharmcomResults;

                                            // Query for tbl_supervisor
                                            connection.query(
                                                'SELECT * admin WHERE SSN = ?',
                                                [userId],
                                                (err, supervisorResults) => {
                                                    if (err) {
                                                        console.error(err);
...
app.get('/users/purchased/:item', (req, res) => {
    ...
    const query = 'SELECT * FROM drugs WHERE formula = ?';
  ...
  app.get('/users/purchased/date/:date', (req, res) => {
    ...
    const query = 'SELECT * FROM prescriptions WHERE date_prescribed = ?';
